...
// campaign «Пепел Камелота»: story missions built from the skirmish and survival rules
const CAMPAIGN = [
  { title: 'Первая кровь', race: 'hum', map: 'river', foes: [{ race: 'orc', diff: 0 }],
    text: 'Орда Чёрного Клыка переправилась через реку и жжёт наши деревни. Король Артур собирает первых воинов. Постройте казармы, наймите батальоны и сожгите крепость орков.' },
  { title: 'Стены Камелота', race: 'hum', map: 'river', mode: 'survival', waves: 8, horde: 'orc', diff: 0,
    text: 'Орки вернулись с ордой. Возведите стены с воротами, откройте тяжёлую броню и выстойте восемь волн. Лагеря чудищ хранят артефакты — отправьте Артура за ними.' },
  { title: 'Горный перевал', race: 'hum', map: 'pass', foes: [{ race: 'dwf', diff: 1 }],
    text: 'Гномы Громгарда поверили слухам и заперли перевал. Узкие проходы любят копейщиков и катапульты. Пробейтесь сквозь скалы и возьмите их чертоги.' },
  { title: 'Союз с эльфами', race: 'hum', map: 'winter', foes: [{ race: 'und', diff: 1 }, { race: 'orc', diff: 1 }], allies: [{ race: 'elf', diff: 1 }],
    text: 'Мордред поднял мёртвых, и Орда пошла за ним. Эльфы Сильваэна встают рядом с нами. Два против двух на снежных холмах — не дайте мертвецам окружить союзника.' },
  { title: 'Пески Кемета', race: 'hum', map: 'pass', foes: [{ race: 'des', diff: 2 }],
    text: 'Фараон Кемета продаёт Мордреду оружие. Его колесницы быстры, а лучники Сета бьют издалека. Держите «Стену щитов» против стрел и ломайте колесницы копьями.' },
  { title: 'Падение Мордреда', race: 'hum', map: 'river', foes: [{ race: 'und', diff: 2 }], gold: 1500,
    text: 'Последняя битва. Легион Мёртвых стоит на острове посреди реки. Соберите лучшую армию, поднимите знамёна и принесите Экскалибур в сердце некрополя.' },
];
